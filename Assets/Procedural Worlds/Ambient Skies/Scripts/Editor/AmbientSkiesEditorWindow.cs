...
namespace AmbientSkies
{
    ...
    public class AmbientSkiesEditorWindow : EditorWindow, IPWEditor
    {
        ...
        private void InfoTab()
        {
            ...
            m_editorUtils.Panel("NewsSettings", NewsSettings, false);
        ...
        private void NewsSettings(bool helpEnabled)
        {
            if (!EditorPrefs.HasKey(AmbientSkiesConsts.PW_SHOW_NEWS + PWApp.CONF.NameSpace))
            {
                EditorPrefs.SetBool(AmbientSkiesConsts.PW_SHOW_NEWS + PWApp.CONF.NameSpace, false);
            }
            else
            { 
                showNews = EditorPrefs.GetBool(AmbientSkiesConsts.PW_SHOW_NEWS + PWApp.CONF.NameSpace);
                EditorGUI.BeginChangeCheck();
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    EditorPrefs.SetBool(AmbientSkiesConsts.PW_SHOW_NEWS + PWApp.CONF.NameSpace, showNews);
                }
            }
        }
        ...
        {
            if (!EditorPrefs.HasKey(AmbientSkiesConsts.ENABLE_NEWS_EDITOR_PREFS))
            {
                EditorPrefs.SetBool(AmbientSkiesConsts.ENABLE_NEWS_EDITOR_PREFS, false);
            }

            if (!EditorPrefs.GetBool(AmbientSkiesConsts.ENABLE_NEWS_EDITOR_PREFS))
            {
                if (EditorUtility.DisplayDialog(m_editorUtils.GetTextValue("AmbientSkiesNews"), m_editorUtils.GetTextValue("AmbientSkiesNewsText"), "Yes", "No"))
                {
                    EditorPrefs.SetBool(AmbientSkiesConsts.PW_SHOW_NEWS + PWApp.CONF.NameSpace, true);
                }
                else
                {
                    EditorPrefs.SetBool(AmbientSkiesConsts.PW_SHOW_NEWS + PWApp.CONF.NameSpace, false);
                ...
                m_editorUtils =  PWApp.GetEditorUtils(this, null, null, null);
                EditorPrefs.SetBool(AmbientSkiesConsts.ENABLE_NEWS_EDITOR_PREFS, true);
            }
        }
